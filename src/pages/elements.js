  ...
  <section>
    ...
    <div className="row gtr-200">
      ...
      <div className="col-6 col-12-medium">
        ...
        <h4>Fit</h4>
        <span className="image fit"><img src="/assets/pic11.jpg" alt=""/></span>
        <div className="box alt">
          <div className="row gtr-50 gtr-uniform">
            <div className="col-4"><span className="image fit"><img src="/assets/pic01.jpg" alt=""/></span></div>
            <div className="col-4"><span className="image fit"><img src="/assets/pic02.jpg" alt=""/></span></div>
            <div className="col-4"><span className="image fit"><img src="/assets/pic03.jpg" alt=""/></span></div>
            {/* Break */}
            <div className="col-4"><span className="image fit"><img src="/assets/pic03.jpg" alt=""/></span></div>
            <div className="col-4"><span className="image fit"><img src="/assets/pic01.jpg" alt=""/></span></div>
            <div className="col-4"><span className="image fit"><img src="/assets/pic02.jpg" alt=""/></span></div>
        ...
        <h4>Left &amp; Right</h4>
        <p><span className="image left"><img src="/assets/pic01.jpg" alt=""/></span>Lorem ipsum dolor sit accumsan
        ...
        <p><span className="image right"><img src="/assets/pic02.jpg" alt=""/></span>Lorem ipsum dolor sit accumsan
          interdum nisi, quis tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis in faucibus
          vestibulum. Blandit adipiscing eu felis iaculis volutpat ac adipiscing accumsan eu faucibus. Integer ac
          pellentesque praesent tincidunt felis sagittis eget. tempus euismod. Vestibulum ante ipsum primis sagittis
          eget. tempus euismod. Vestibulum ante ipsum primis in faucibus vestibulum. Blandit adipiscing eu felis iaculis
